...
<body>
    ...
    <div id="page-wrap">
              ...
              <div class="slideshow-container">
                ...
                <div id="question">
                  <p>您認為天燈該不該放?</p>
                  <button type="button" name="yes" value="yes" id="yes" onclick="vote(1)" style="background-color:#59F4F4;">應該</button>
                  <button type="button" name="no" value="no" id="no" onclick="vote(0)" style="background-color:#FDF54D;">不應該</button>
